...
export const __wbg_get_searchiterationresponse_depth: (a: number) => number;
export const __wbg_get_searchiterationresponse_mv: (a: number) => number;
...
export const __wbg_set_searchiterationresponse_depth: (a: number, b: number) => void;
export const __wbg_set_searchiterationresponse_mv: (a: number, b: number) => void;
