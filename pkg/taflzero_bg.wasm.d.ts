...
export const engineclient_get_available_moves: (a: number, b: number) => void;
...
export const engineclient_set_variant: (a: number, b: number, c: number, d: number) => void;
...
export const get_sq_algebraic: (a: number, b: number, c: number) => void;
...
export const wasmclient_set_nn: (a: number, b: number, c: number, d: number) => void;
